...
class AdminMediaLibraryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@CMS/Admin/MediaLibrary/index.html.twig', [
    ...
    public function createStorageAction(Request $request)
    {
        ...
        return $this->render('@CMS/Admin/MediaLibrary/create_storage.html.twig', [
    ...
    public function editStorageAction(Request $request, $id)
    {
        ...
        return $this->render('@CMS/Admin/MediaLibrary/edit_storage.html.twig', [
            'form'   => $form->createView(),
        ]);
    }
    ...
    public function createCollectionAction(Request $request)
    {
        ...
        return $this->render('@CMS/Admin/MediaLibrary/create_collection.html.twig', [
            'form'   => $form->createView(),
        ]);
    }
    ...
    public function editCollectionAction(Request $request, $id)
    {
        ...
        return $this->render('@CMS/Admin/MediaLibrary/edit_collection.html.twig', [
            'form'   => $form->createView(),
        ]);
    }
}
